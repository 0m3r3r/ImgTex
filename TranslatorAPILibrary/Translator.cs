...
namespace TranslatorAPILibrary
{
    public class Translator
    {
        ...
        private readonly string _clientId = "Imgtex";
        private readonly string _clientSecret = "Imgtextranslotar78963";
